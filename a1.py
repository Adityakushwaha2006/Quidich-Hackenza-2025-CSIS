...
# Process all frames
all_3d_points = []
for frame_number in range(1, 507):  # Start from 1 to 506
...
def update(frame):
    ...
    ax.set_xlim([-1000, 1000])  # Adjust these limits based on your data
...
anim.save('3d_pose_animation.gif', writer='pillow', fps=20)
plt.show()
plt.close(fig)
