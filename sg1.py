...
def process_frame_batch(frame_batch):
    """Process a batch of frames using shared resources"""
    batch_results = []
    for frame_num in frame_batch:
        # File loading and error handling (same as before)
    ...
    batch_results.append(points_3d)
...
def main():
    ...
    with Manager() as manager:
        ...
        # Convert to regular list for visualization
